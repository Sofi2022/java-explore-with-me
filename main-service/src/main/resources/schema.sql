drop table if exists users, locations, participation_requests, events, categories, compilations, compilation_events cascade;
...
(
    ...
    compilation        bigint
        constraint fkmo9295ahmpdkoaoanv55s4f5e
